    ...
    return (
        <div className="container">
            ...
            {cartCoupons.map(coupon => (
                <div key={coupon.id} className="mb-4 d-flex flex-column">
                    <div  className="mb-4 d-flex justify-around flex-wrap">
                    ...
                    <Box>
                        <h6 className='mb-3'>Comparte el cupón en tus redes sociales:</h6>
